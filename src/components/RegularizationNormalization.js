...
const RegularizationViz = () => {
  ...
  const generateActivationMatrix = () => {
    return [
  ...
  const activationMatrix = generateActivationMatrix();
  
  // Get color - simplified version
  const getColor = (value) => {
    // Map value to color
    const normalized = Math.max(-2, Math.min(2, value)); // Clip to -2 to 2 range
  ...
  return (
    <div className="p-4 bg-gray-50 rounded-lg">
      <h2 className="text-xl font-bold text-center mb-6">Regularization and Normalization: Core Comparison</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="relative p-3 bg-blue-50 rounded border border-blue-200">
          <h4 className="font-bold text-center mb-3">Weight Regularization: L1 vs L2</h4>
          
          <div className="mb-4">
            <div className="flex items-center mb-2">
              <div className="w-3 h-3 bg-purple-500 rounded-full mr-2"></div>
              <span className="text-sm">No Regularization</span>
              <div className="w-3 h-3 bg-green-500 rounded-full ml-4 mr-2"></div>
              <span className="text-sm">L1 Regularization</span>
              <div className="w-3 h-3 bg-blue-500 rounded-full ml-4 mr-2"></div>
              <span className="text-sm">L2 Regularization</span>
            </div>
            
            {/* Simplified weight chart */}
            <div className="relative h-48 w-full border-b border-l border-gray-400 mt-8">
              {/* Y-axis label */}
              <div className="absolute -left-7 -top-6 text-sm font-bold text-gray-700">
                Weight Value
              </div>
              ...
              {/* X-axis label */}
              <div className="absolute bottom-[-24px] w-full text-center text-sm font-bold text-gray-700">
              ...
              <div className="absolute inset-0 flex items-end justify-around">
                {weights.map((item, index) => (
                  <div key={index} className="flex flex-col items-center w-12">
                    {/* No regularization */}
                    <div 
                      className="w-3 bg-purple-500 mb-1" 
                      style={{ 
                    ...
                    {/* L1 regularization */}
                    <div 
                      className="w-3 bg-green-500 mb-1" 
                      style={{ 
        ...
        <div className="relative p-3 bg-purple-50 rounded border border-purple-200">
          <h4 className="font-bold text-center mb-3">Activation Normalization: Batch vs Layer</h4>
          
          <div className="grid grid-cols-1 gap-4">
            {/* Original, Batch Norm and Layer Norm activation representations */}
            <div className="grid grid-cols-3 gap-2">
              {/* Original activations */}
              <div className="text-center">
                <h4 className="text-sm font-bold mb-1">Original Activations</h4>
                <div className="flex mb-2">
                  <div className="rotate-90 text-xs font-bold mr-1 flex-shrink-0 relative" style={{width: '20px', marginLeft: '-8px'}}>
                    <span style={{position: 'absolute', transform: 'translateX(-100%)', whiteSpace: 'nowrap', top: '40px'}}>Samples (Data Points)</span>
                  </div>
                  <div>
                    <div className="text-xs font-bold mb-1 text-center">Neurons</div>
                    <div className="grid grid-cols-5 gap-1 p-1 bg-gray-100 rounded mx-auto" style={{width: 'fit-content'}}>
                      {[0,1,2,3].map(row => (
              ...
              {/* Batch Norm */}
              <div className="text-center">
                <h4 className="text-sm font-bold mb-1">Batch Norm</h4>
                <div className="relative mb-2">
                  ...
                  <div className="absolute top-[50%] right-[-14px] transform rotate-90">
                    <svg width="70" height="24">
                      <path d="M5,12 L65,12" stroke="#4C1D95" strokeWidth="2" />
                      <path d="M60,7 L65,12 L60,17" fill="none" stroke="#4C1D95" strokeWidth="2" />
                    </svg>
                  </div>
                </div>
              ...
              {/* Layer Norm */}
              <div className="text-center">
                <h4 className="text-sm font-bold mb-1">Layer Norm</h4>
                <div className="relative mb-2">
                  <div className="text-xs font-bold mb-1 text-center">Neurons</div>
                  <div className="grid grid-cols-5 gap-1 p-1 bg-gray-100 rounded mx-auto" style={{width: 'fit-content'}}>
                    {[0,1,2,3].map(row => (
                  ...
                  <div className="absolute top-[50%] left-[-18px]">
                    <svg width="70" height="24">
                      <path d="M5,12 L65,12" stroke="#9D174D" strokeWidth="2" />
                      <path d="M60,7 L65,12 L60,17" fill="none" stroke="#9D174D" strokeWidth="2" />
                    </svg>
                  </div>
                </div>
      ...
      <div className="mt-6 p-4 bg-white rounded shadow">
        <h3 className="font-bold mb-2">Combined Application in Deep Learning Practice</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="relative p-3 bg-blue-50 rounded border border-blue-200">
            ...
            <div className="relative mx-auto" style={{width: '90%', height: '180px'}}>
              ...
              <div className="absolute inset-0 flex items-center justify-between px-4">
                ...
                {/* Conv layer 1 */}
                <div className="flex flex-col items-center">
                  <div className="w-16 h-20 bg-yellow-100 rounded flex items-center justify-center">
                ...
                <div className="flex flex-col items-center">
                  <div className="w-16 h-24 bg-blue-100 rounded flex items-center justify-center">
            ...
            <div className="mt-12 text-xs p-2 bg-blue-100 rounded">
          ...
          <div className="relative p-3 bg-purple-50 rounded border border-purple-200">
            ...
            <div className="relative mx-auto" style={{width: '90%', height: '180px'}}>
              ...
              <div className="absolute inset-0 flex items-center justify-between px-4">
                ...
                {/* Attention block */}
                <div className="flex flex-col items-center">
                  <div className="w-16 h-8 bg-purple-200 rounded flex items-center justify-center">
                  ...
                  <div className="w-16 h-8 bg-indigo-100 rounded mt-1 flex items-center justify-center">
            ...
            <div className="mt-12 text-xs p-2 bg-purple-100 rounded">
        ...
        <div className="p-3 bg-yellow-50 rounded border border-yellow-200 mt-4">
          <h4 className="font-bold text-center">Reasons for Combined Usage in Deep Learning</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
            <div className="flex items-start">
              ...
              <div>
                <p className="text-sm"><strong>Complementary Effects:</strong> Weight regularization controls model complexity, activation normalization improves training stability - they solve different problems</p>
              </div>
            </div>
            <div className="flex items-start">
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-sm"><strong>Flexible Combination:</strong> Different architectures and tasks need different normalization and regularization combinations, modern frameworks support mixing them</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-3 bg-gray-50 rounded border border-gray-300 mt-4">
          <h4 className="font-bold text-center">PyTorch Code Example: Activation Normalization + Weight Regularization</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
    ...
    weight_decay=1e-4  # L2 regularization
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="p-2 bg-white rounded shadow-inner">
                <p className="text-xs">
                  <strong>Key Implementation Pattern:</strong> In this example, BatchNorm is added as part of the model architecture, while L2 regularization is configured as an optimizer parameter. This reflects the standard pattern in deep learning frameworks, highlighting the different implementation approaches for these techniques.
                </p>
              </div>
            </div>
          </div>
