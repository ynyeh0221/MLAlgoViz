      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-4 bg-white rounded shadow-md">
          ...
          <div className="relative h-56 w-full border-b border-l border-gray-400 mt-8 mb-8 overflow-visible">
            ...
            {/* X-axis label */}
            <div className="absolute bottom-8 w-full text-center text-sm font-bold text-gray-700">
      ...
      <div className="mt-6 p-4 bg-white rounded shadow-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          <div className="relative p-4 bg-blue-50 rounded border border-blue-200">
            ...
            <div className="relative mx-auto w-full h-44">
              ...
              {/* Weight decay marker */}
              <div className="absolute bottom-0 left-0 right-0 text-center mt-6">
